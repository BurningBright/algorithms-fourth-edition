...
public class Interval2D {
    ...
    /**
     * Does this two-dimensional interval contain another?
     * @param interval the two-dimensional interval
     * @return true if this two-dimensional interval 
     * 			contains the another; false otherwise
     */
    public boolean contains(Interval2D that) {
    	return contains(new Point2D(that.x.left(), that.y.left())) &&
    			contains(new Point2D(that.x.right(), that.y.right()));
    }
