 ...
 */
public class PlotsSeparate extends AmortizedCostPlots {
    
    public void plotsSeparateChainingHashST() {
        
        SeparateChainingHashSTPlot<String, Object> sst = 
                new SeparateChainingHashSTPlot<String, Object>();
//        new SeparateChainingHashSTPlot<String, Object>(997);
        ...
        a2d.setRadius(.0005);
        a2d.setChartDesc("Separate hash plot");
    ...
    public static void main(String[] args) {
        new PlotsSeparate().plotsSeparateChainingHashST();
    }
