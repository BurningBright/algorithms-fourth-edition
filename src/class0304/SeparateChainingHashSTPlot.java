 ...
 *  @author Kevin Wayne
 */
public class SeparateChainingHashSTPlot<Key, Value> {
     ...
     */
    public SeparateChainingHashSTPlot() {
        this(INIT_CAPACITY);
    } 
    ...
    public SeparateChainingHashSTPlot(int m) {
        this.m = m;
    ...
    private void resize(int chains) {
        SeparateChainingHashSTPlot<Key, Value> temp = new SeparateChainingHashSTPlot<Key, Value>(chains);
        for (int i = 0; i < m; i++) {
