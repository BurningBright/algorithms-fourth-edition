...
public class FixedCapStackOfStrings implements Iterable<String> {
    private String[] a;  // holds the items
    private int N;       // number of items in stack

    // create an empty stack with given capacity
    public FixedCapStackOfStrings(int capacity) {
    ...
    public static void main(String[] args) {
        ...
        FixedCapStackOfStrings stack = new FixedCapStackOfStrings(max);
        while (!StdIn.isEmpty()) {
