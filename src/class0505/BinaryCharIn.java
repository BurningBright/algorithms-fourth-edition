 ...
 *  @author Kevin Wayne
 */
public final class BinaryCharIn {
   ...
   /**
     ...
     */
    public BinaryCharIn(InputStream is) {
   ...
   /**
     ...
     */
    public BinaryCharIn(Socket socket) {
        try {
    ...
    private void fillBuffer() {
        try {
            for (int i = 0; i < 8; i++) {
                ...
                if (ch != 48 && ch != 49)
                    throw new IOException("input 0/1");
                buffer = (buffer << 1) + (ch == 48? 0: 1);
            }
//            StdOut.println(buffer);
   ...
   /**
    ...
    public static void main(String[] args) {
        BinaryCharIn  in  = new BinaryCharIn(args[0]);
